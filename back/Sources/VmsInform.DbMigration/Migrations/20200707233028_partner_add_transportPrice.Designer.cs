...
namespace VmsInform.DbMigration.Migrations
{
    ...
    [Migration("20200707233028_partner_add_transportPrice")]
    partial class partner_add_transportPrice
    {
            ...
            modelBuilder.Entity("VmsInform.DAL.Domain.Good", b =>
                {
                    ...
                    b.Property<long?>("SellCurrencyId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("VmsInform.DAL.Domain.Good", b =>
                {
                    ...
                    b.HasOne("VmsInform.DAL.Domain.Currency", "SellCurrency")
                        .WithMany()
